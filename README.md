...
- **Path** `0:/macros/System`  
  - **Cold Pull** – Added LED indication.  
- **Path** `0:/macros/System/Settings/Chamber/`  
...
- **Path:** `0:/macros/System/Settings/Network/`  
  - **Connect to new WiFi network** – Disables Ethernet to PC mode. Added custom network name.  
  - **Enable Ethernet Mode** – Disables Ethernet to PC mode. Changed M552 I0 S1 to M552 I0 P0.0.0.0 S1.  
  - **Enable WiFi \- Access Point Mode** – Disables Ethernet to PC mode. Added custom network name.  
...
- **Path** `0:/sys/`  
  - **config** – Switching to Ethernet to PC mode is now automatic. Added filter configuration. New global variables are declared: periodic\_wiping, ethernetToPCmode, hepafan. Bed heater fault detection is now configured via the bedfaultdetection.g macro. Made Hepafan thermodependent.  
  - **initial** – Added filter activation. Made Hepafan not thermodependent  
  - **end** – Added filter deactivation. Added filter fault message. Made Hepafan thermodependent  
  ...
  - **networktest** – Changed M552 I0 S1 to M552 I0 P0.0.0.0 S1. Added custom network name.  
  - **nozzlewipe** – Fixed the bug.  
- **Path** `0:/gcodes/Slicer/Tests/`  
